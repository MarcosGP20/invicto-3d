...
const materiales: QuoteFormData["material"][] = [
  "PLA",
  "PETG",
  "TPU",
  "Resina",
...
export default function QuoteModal({ open, onClose, productoInicial }: QuoteModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      ...
      <div className="relative z-10 w-full max-w-lg overflow-y-auto rounded-t-3xl bg-white sm:rounded-3xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5">
          <h2 className="text-lg font-semibold text-gray-900">Solicitar cotización</h2>
          <button
            onClick={onClose}
        ...
        <div className="max-h-[80vh] overflow-y-auto px-6 py-6">
          {status === "success" ? (
            <div className="flex flex-col items-center py-8 text-center">
              ...
              <h3 className="mt-4 text-xl font-semibold text-gray-900">¡Cotización enviada!</h3>
              <p className="mt-2 text-sm text-gray-600">
                Te respondemos con un presupuesto detallado en menos de 24 horas.
              </p>
            ...
            <>
              ...
              <div className="mb-6 rounded-xl border border-green-200 bg-green-50 p-4">
                <p className="text-sm font-medium text-green-800">¿Querés respuesta inmediata?</p>
                <a
              ...
              <p className="mb-6 text-center text-xs text-gray-400">— o completá el formulario —</p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
                ...
                <div className="border-t border-gray-100 pt-5">
                  <p className="mb-4 text-sm font-medium text-gray-700">Tus datos de contacto</p>
